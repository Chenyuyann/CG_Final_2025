...
if __name__ == '__main__':  
    ...
    dataname = 'simplecar'
    source_code_path = f'outputs/{dataname}/stage0/results/{dataname}_general_allnodes.scad'
    pixel2code_dir = f'outputs/{dataname}/stage1/working_dir/{dataname}_general_allnodes.scad'
    predicted_info_dir = f'outputs/{dataname}/stage3/{dataname}_general_allnodes.scad'
    save_dir = f'outputs/{dataname}/stage4/'
    ...
    # PROMPTS = ["locomotive", "wheels", "car", "coupler", "smokestack"] # train
    # PROMPTS = ["head", "body", "eyes", "beak", "wing", "tail", "feet", "hat", "tie", "jacket"] # wintertux
    # PROMPTS = ["Head", "Body", "Eyes", "Nose", "Mouth", "Arms", "Buttons", "Hat", "Scarf", "Broom"] # snowman
    # PROMPTS = ["Trunk", "Branches", "Ornaments", "Stand", "Leaves", "Top"] # christmastree
    # PROMPTS = ["Head", "Body", "Eyes", "Legs", "Mouth"] # creeper
    # PROMPTS = ["Trunk", "Ears", "Tusks", "Legs", "Feet", "Tail", "Eyes", "Body"] # elephant
    # PROMPTS = ["Blade", "Base"] # fan
    # PROMPTS = ["Seat", "Backrest", "Legs"] # lowchair
    # PROMPTS = ["Head", "Body", "Eyes", "Beak", "Wings", "Tail"] # rubberduck
    PROMPTS = ["Body", "Wheels", "Windows", "Doors", "Lights"] # simplecar
