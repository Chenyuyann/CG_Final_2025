...
# ["head", "body", "leg", "tail", "hump", "neck", "feet"]
# ["face", "body", "leg"]
camel_syn_ds = {
    'head':'face',
    'body':'body',
...
dataname = 'simplecar'
count_syn = simplecar_syn_gmn
# BASE_PATH = '/home/cli7/yhc_Workspace/label_res_llama2/tablev1e'
# BASE_PATH = '/remote-home/chenyuyan/CADTalk/outputs/animals/stage4'
BASE_PATH = f'/remote-home/chenyuyan/CADTalk/outputs/{dataname}/stage4'

output_path = f'/remote-home/chenyuyan/CADTalk/outputs/{dataname}/{dataname}.csv'
