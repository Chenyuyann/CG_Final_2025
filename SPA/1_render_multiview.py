...
if __name__ == "__main__":
    # wd = 'examples/stage1/working_dir'
    # pd = 'examples/stage1/program_dir'
    # md = 'examples/stage1/model_dir'
    dataname = 'simplecar'
    wd = f'outputs/{dataname}/stage1/working_dir'
    pd = f'outputs/{dataname}/stage1/program_dir'
    md = f'outputs/{dataname}/stage1/model_dir'
    vfb = 'virtualfb/virtualfb.sh'
